    ...
    def get_actions(self):
            ...
            for cargo in self.cargos:
                for loc in self.airports:
                    for plane in self.planes:
                        precond_pos = [expr("At({}, {})".format(cargo, loc)), expr("At({}, {})".format(plane, loc)) ]
                        precond_neg = []
                        effect_add = [expr("In({}, {})".format(cargo, plane))]
                        effect_rem = [expr("At({}, {})".format(cargo, loc))]
                        load = Action(expr("Load({}, {}, {})".format(cargo, plane, loc)), [precond_pos, precond_neg],
        ...
        def unload_actions():
            ...
            for cargo in self.cargos:
                for loc in self.airports:
                    for plane in self.planes:
                        precond_pos = [expr("In({}, {})".format(cargo, plane)), expr("At({}, {})".format(plane, loc)) ]
                        precond_neg = []
                        effect_add = [expr("At({}, {})".format(cargo, loc))]
                        effect_rem = [expr("In({}, {})".format(cargo, plane))]
                        unload = Action(expr("Unload({}, {}, {})".format(cargo, plane, loc)), [precond_pos, precond_neg],
                                      [effect_add, effect_rem])
